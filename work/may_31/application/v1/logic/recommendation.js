...
const recommendationApi = require('../model/api/recommendation-api');
const hardcodedMockData = require('../model/api/mock-recommendations.json');
...
class Recommendation extends BaseLogic {
    ...
    static async getPDFLink(recommendation_id) {
        const results = await new recommendationApi().getById(recommendation_id);
        return results.game_plan_pdf;
    }
