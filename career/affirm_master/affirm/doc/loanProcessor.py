...
# File Names
#########################################
output_assignments = 'C:/wamp/www/development/career/affirm/data/large/assignments.csv'  # outputs loan to facility mapping
output_yields = 'C:/wamp/www/development/career/affirm/data/large/yields.csv'            # outputs expected yields of facilities

input_facilities = 'C:/wamp/www/development/career/affirm/data/large/facilities.csv'     # facilities
input_covenants = 'C:/wamp/www/development/career/affirm/data/large/covenants.csv'       # covenants
input_loans = 'C:/wamp/www/development/career/affirm/data/large/loans.csv'               # loans
...
print(LoanProcessor.facilitiesSorted)
